...
require_once(PUSH_SDK_HOME.'/push/configure.php');

require_once(PUSH_SDK_HOME.'/push/HttpRequest.php');
require_once(PUSH_SDK_HOME.'/push/PushException.php');
require_once(PUSH_SDK_HOME.'/push/PushSimpleLog.php');
require_once PUSH_SDK_HOME . '/push/AssertHelper.php';
